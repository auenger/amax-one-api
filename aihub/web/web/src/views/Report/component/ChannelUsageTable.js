...
const headCells = [
  { id: 'channel_name', label: '渠道名称', sortable: true },
...
const ChannelUsageTable = ({ isLoading, data }) => {
            ...
            <TableBody>
              {paginatedData.length > 0 ? (
                paginatedData.map((row, index) => (
                  <TableRow hover key={`${row.channel_name}_${index}`}>
...
ChannelUsageTable.propTypes = {
  isLoading: PropTypes.bool,
  data: PropTypes.array
};

export default ChannelUsageTable;
