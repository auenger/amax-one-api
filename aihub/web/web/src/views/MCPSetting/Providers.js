  ...
  return (
    <>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2.5}>
        <Typography variant="h3">MCP 供应商</Typography>
        <Button variant="contained" color="primary" startIcon={<IconPlus size={18} />} onClick={handleOpenAdd}>
          添加供应商
        </Button>
      </Stack>
      ...
      <Card
        sx={{
          border: `1px solid ${(t) => t.palette.divider}`,
          boxShadow: 'none'
        }}
      >
