              ...
              <AnimateButton>
                ...
                >
                  <Box sx={{ mr: { xs: 1, sm: 2, width: 20 }, display: 'flex', alignItems: 'center' }}>
                    <img src={Github} alt="github" width={22} height={22} style={{ marginRight: matchDownSM ? 8 : 16 }} />
                  </Box>
                  使用 GitHub 登录
                </Button>
              </AnimateButton>
          ...
          {siteInfo.wechat_login && (
            <Grid item xs={12}>
              <AnimateButton>
                ...
                >
                  <Box sx={{ mr: { xs: 1, sm: 2, width: 20 }, display: 'flex', alignItems: 'center' }}>
                    <img src={Wechat} alt="Wechat" width={22} height={22} style={{ marginRight: matchDownSM ? 8 : 16 }} />
                  </Box>
                  使用微信登录
                </Button>
              </AnimateButton>
          ...
          {siteInfo.lark_client_id && (
            <Grid item xs={12}>
              <AnimateButton>
                ...
                >
                  <Box sx={{ mr: { xs: 1, sm: 2, width: 20 }, display: 'flex', alignItems: 'center' }}>
                    <img src={Lark} alt="Lark" width={22} height={22} style={{ marginRight: matchDownSM ? 8 : 16 }} />
                  </Box>
                  使用飞书登录
                </Button>
              </AnimateButton>
          ...
          {siteInfo.oidc && (
            <Grid item xs={12}>
              <AnimateButton>
                ...
                >
                  <Box sx={{ mr: { xs: 1, sm: 2, width: 20 }, display: 'flex', alignItems: 'center' }}>
                    <img src={OIDC} alt="OIDC" width={22} height={22} style={{ marginRight: matchDownSM ? 8 : 16 }} />
                  </Box>
                  使用 OIDC 登录
                </Button>
              </AnimateButton>
