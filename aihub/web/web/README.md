...
ModelHub 的前端界面，基于 [Berry Free React Admin Template](https://github.com/codedthemes/berry-free-react-admin-template) 进行深度定制开发。
...
1. `src/constants/ChannelConstants.js`
...
2. `src/views/Channel/type/Config.js`
